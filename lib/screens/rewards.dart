          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ...
                Text('13 July 1623', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Colors.blue))
              ],
            ),
            Row(
              children: <Widget>[
                Text('Reward received -', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: Colors.black),),
                Text('Yes', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Colors.blue))
              ],
            ),
            Row(
              children: <Widget>[
                Text('Reward Amount -', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: Colors.black),),
                Text('INR 1500', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Colors.blue))
              ],
            )
          ],
        ),
